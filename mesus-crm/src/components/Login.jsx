...
export default function Login({ accessKey, setAccessKey, handleLogin, error }) {
    return (
        <div className="min-h-screen bg-[#0d1117] flex items-center justify-center p-4">
            <div className="bg-[#161b22] p-12 rounded-[3rem] shadow-2xl w-full max-w-lg border border-[#30363d] relative overflow-hidden text-left">
                ...
                <input 
                    ...
                    className="w-full p-6 bg-[#0d1117] border border-[#30363d] rounded-2xl text-white font-bold outline-none focus:border-indigo-500 transition-all mb-4 placeholder:text-slate-700" 
                    value={accessKey} 
